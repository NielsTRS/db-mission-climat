...
class Window(tk.Toplevel):
    ...
    def extract_data(self):
        ...
        try:
            query = """
                WITH Data AS (
                    SELECT D.code_departement, D.nom_departement, strftime('%Y', M.date_mesure) as annee, M.temperature_moy_mesure, M.temperature_min_mesure, M.temperature_max_mesure
                    FROM Departements D
